...
export default function List({
  ...
  return (
    <div className="max-w-md min-w-[300px] border rounded-lg flex flex-col p-2 relative bg-blue-600">
...
export function NoteArea({ children, ...rest }) {
  return (
    <div className="container min-h-[200px] flex flex-col bg-blue-700 mx-auto p-1 mb-2 rounded-md md:min-w-[25%]">
      {children}
    </div>
  );
}
